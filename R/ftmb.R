...
#
# Public TMB SRR API (this package):
#   ftmb    year-varying SPR0 (FLQuant aligned to rec years)
#   ftmb2   scalar / mean SPR0; used by eql()
#   ftmb3   iterates ftmb2 when the FLSR has iters
# Dynamic-B0 TMB fits (year-specific v_t) are FLRebuild::ftmb_b0dyn.
# A B0 trajectory without an SRR is rec * spr0Yr.
...
#'
#' @seealso \code{\link{ftmb2}}, \code{\link{ftmb3}}, \code{\link{eql}},
#'   \code{\link{eqlFn}}, FLRebuild::ftmb_b0dyn
#'
#' @export
#' 
#' \dontrun{
...
ftmb<-function(object, 
  ...
  # CREATE TMB object
  Obj=TMB::MakeADFun(data=inp$Data, parameters=inp$Params, map=Map, DLL="icesdata", silent=TRUE)
...
#' @return A list containing elements 'FLSR', of class *FLSR*
#'
#' @seealso \code{\link{ftmb}}, \code{\link{eql}}, FLRebuild::ftmb_b0dyn
#'
#' @examples
#' # See ftmb for usage
#'
